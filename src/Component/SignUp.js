...
function SignUp() {
    ...
    $(document).ready(function () {
        ...
        $("input[type='text']").keyup(function (event) {
            ...
            if (focusInput.val().length > 1) {
                if (focusInput.attr('name') === 'email' && focusInput.attr('name') === 'phone' && !validatePhone(focusInput.val())) {
                    $('#next-page').css('opacity', 0);
                } else {
                    $('#next-page').css('opacity', 1);
                }
    ...
    function showLi(focusInput) {
        ...
        if (focusInput.attr('id') === 'viewpswd') {
            $("[data-ref='" + focusInput.attr('id') + "']").addClass('done').html('password'); //                    .html(Array(focusInput.val().length+1).join("*"));
        } else {
    ...
    return (
        <Formcontainer>
            <div className="navigation">
                <ol>
                    <li><span href="#" data-ref="name">Name</span></li>
                    <li><span href="#" data-ref="uname">Username</span></li>
                    <li><span href="#" data-ref="email">Email</span></li>
                </ol>
            </div>
            <form id="sign-form" className="sign-form">
                <ol className="questions">
                    <li>
                        ...
                        <input className="active" id="name" name="name" type="text" placeholder="" autoFocus />
                    </li>
                    <li>
                        <span><label htmlFor="uname">& what shall we call you?</label></span>
                        <input id="uname" name="username" type="text" placeholder="" autoFocus />
                    </li>
                    <li>
                        <span><label htmlFor="email">Enter you email</label></span>
                        <input id="email" name="email" type="text" placeholder="" autoFocus />
                    </li>
                    <li>
                    ...
                    <li><p>
                        <Button href="#" id="signup">sign up</Button></p></li>
